...
export function ClienteFormSheet({
  ...
  const submit = form.handleSubmit(async (values) => {
    await onSubmit({
      ...
      empresa: optional(values.empresa),
      email: optional(values.email),
      telefone: optional(values.telefone),
      documento: optional(values.documento),
        ...
        <SheetHeader>
          ...
          <SheetDescription>
            {cliente
              ...
              : "Cadastre um cliente para organizar sua operação."}
          </SheetDescription>
        </SheetHeader>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input autoFocus placeholder="Nome do cliente" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea rows={5} placeholder="Informações adicionais" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
