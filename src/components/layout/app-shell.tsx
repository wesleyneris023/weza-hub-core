      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-30 flex h-16 items-center gap-3 border-b border-glass-border bg-header-glass px-4 backdrop-blur-xl sm:px-6 lg:px-8">
            ...
            <div className="ml-auto grid size-9 place-items-center rounded-full border border-glass-border bg-surface-strong font-display text-sm font-semibold text-foreground shadow-soft" aria-label="Perfil do usuário">W</div>
          </header>
          {children}
        </div>
      </div>
